				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						...
						<div class="row">
							<div class="  col-md-6">
								<div class="thumbnail">
									...
									<div class="caption ">
										...
										<a href="#" class="col-md-6 btn btn-default" role="button">영화정보</a>
										<a href="#" class="col-md-6 btn btn-danger" role="button">예매하기</a>
							...
							<div class=col-md-6>
								<div class="thumbnail">
									<img src="./img/your_arm_number.jpg" height="400" width="300">
									<div class="caption">
										<h3>니군번은</h3>
					...
					<div class="item  ">
						...
						<div class="row">
							...
							<div class="  col-md-6">
								<div class="thumbnail">
									<img src="./img/station_of_sokcho.jpg" height="400" width="300">
									<div class="caption">
										<h3>속초에 가보니 피카츄가 울고있다</h3>

										<a href="./movieA.jsp" class="btn btn-default col-md-6"
											role="button">영화정보</a> <a href="#"
											class="btn btn-danger col-md-6" role="button">예매하기</a>
