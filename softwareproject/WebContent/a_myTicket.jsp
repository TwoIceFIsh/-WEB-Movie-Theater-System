...
<jsp:include page="nav.jsp" />
		...
		if (session.getAttribute("MEMBER_ID") != null) {
			...
			AdminDAO TICKET = new AdminDAO();
			ArrayList<TicketDTO> TICKETS = TICKET.getTicket(MEMBER_ID);
	%>
			...
			<div class="movie-content">
				...
				<div class="movie-info">
					<div class="info-section">
						<label>발권자</label> <span><%=TIC.getMEMBER_ID() %></span>
					</div>
					<div class="info-section">
						<label>일자</label> <span><%=TIC.getSCREEN_DATE() %></span>
					</div>
					<!--date,time-->
					<div class="info-section">
						<label>상영관</label> <span><%=TIC.getSCREEN_NUMBER() %>관</span>
					</div>

					<!--row-->
					<div class="info-section">
						<label>좌석</label> <span><%=TIC.getSEAT_NUMBER() %>번</span>
					</div>
					<!--seat-->
				</div>
			</div>
