...
function goTo() {
	...
	window.location.href = './a_index.jsp';
}
function goTo2() {

	window.location.href = './a_screenList.jsp';
}
function goTo3() {

	window.location.href = './a_myTicket.jsp';
}
